<h1>Tambah Data</h1>
<form action="kwu-data-tambah.php" method="POST">
    <label for="kodebarang"> kodebarang :</label>
    <input  type="number" name="kodebarang" placeholder="Ex. 1210024552"/><br>

    <label for="tanggal"> tanggal :</label>
    <input  type="date" name="tanggal" placeholder="Ex. 11-06-2020"/><br>

    <label for="namabarang"> namabarang :</label>
    <input  type="text" name="namabarang" placeholder="Ex. nescafe"/> <br>

    <label for="pembeli"> pembeli :</label>
    <input  type="text" name="pembeli" placeholder="Ex. Kazuha"/><br>

    <label for="qty"> qty :</label>
    <input  type="number" name="qty" placeholder="Ex. 3"/><br>

    <label for="hagabeli"> hargabeli :</label>
    <input  type="number" name="hargabeli" placeholder="Ex. 7500"/><br>
