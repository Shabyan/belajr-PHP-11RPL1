<?php 
      ...
      echo "<a href='kwu-data-tambah.php'>Tambah Data</a>";
      echo "<hr>";
      ...
      while($row = mysqli_fetch_array($data)){
            ...
            $tabledata .= "
                  <tr>
                        ...
                        <td>
                              <a href='kwu-data-edit.php?kodebarang=".$row["kodebarang"]."'>Edit</a>
                              &nbsp;-&nbsp;
                              <a href='kwu-data-hapus.php?kodebarang=".$row["kodebarang"]."' 
