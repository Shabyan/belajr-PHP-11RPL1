...
<form action="edit-datasiswa.php" method="POST">
    ...
    <input value="<?php echo $row["nis"] ?>" readonly type="number" name="nis" placeholder="1210092" /> <br>

    <label for="nama">Nama lengkap</label>
    <input value="<?php echo $row["nama_lengkap"] ?>" type="text" name="nama" placeholder="Ex. Firdaus Wiguna" /> <br>
